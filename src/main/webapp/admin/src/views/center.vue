  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='yonghu'"  label='用户审核' prop="yonghuYesnoTypes">
                 <el-select v-model="ruleForm.yonghuYesnoTypes"  placeholder='请选择用户审核'>
                     <el-option
                             v-for="(item,index) in yonghuYesnoTypesOptions"
                             v-bind:key="item.codeIndex"
                             :label="item.indexName"
                             :value="item.codeIndex">
                     </el-option>
...
// 注册表 商家 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.yonghuYesnoTypes)&& 'yonghu'==this.flag){
