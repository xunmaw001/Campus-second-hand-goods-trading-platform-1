    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='yonghu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="用户审核" prop="yonghuYesnoValue">
                        <el-input v-model="yonghuForm.yonghuYesnoValue"
                                  placeholder="用户审核" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="用户审核" prop="yonghuYesnoValue">
                            <el-input v-model="ruleForm.yonghuYesnoValue"
