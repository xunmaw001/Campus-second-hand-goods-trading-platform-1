    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.yonghuYesnoTypes" label="用户审核" prop="yonghuYesnoTypes">
                        <el-input v-model="ruleForm.yonghuYesnoValue" placeholder="用户审核" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   yonghuYesnoTypes: [
                              { required: true, message: '用户审核不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
