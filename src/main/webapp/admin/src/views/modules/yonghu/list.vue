        ...
        <el-dialog title="审核" :visible.sync="yonghuYesnoTypesVisible">
            <el-form :model="form">
                ...
                <el-form-item label="审核" >
                    <el-select v-model="form.yonghuYesnoTypes" placeholder="请选择用户审核">
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="yonghuYesnoTypesShenhe">审 核</el-button>
            </div>
        </el-dialog>
        <!-- 条件查询 -->
        <div v-if="showFlag">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/xiaoyuanershouwupinjiaoyi/upload/yonghuMuBan.xls"
                        >批量导入用户数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('yonghu','导入导出')"
                ...
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('yonghu','审核') && scope.row.yonghuYesnoTypes == 1 " type="primary" icon="el-icon-thumb" size="mini" @click="openYesnoTypes(scope.row.id)">审核</el-button>
    ...
    //当前表下拉框搜索条件
        ...
        methods: {
            ...
            openYesnoTypes(id) {
                ...
                _this.form.id = null;
                _this.form.id = id;
                            _this.form.yonghuYesnoTypes = "请选择用户审核";
                _this.yonghuYesnoTypesVisible = true;
            },

            yonghuYesnoTypesShenhe() {
                let _this = this;
                if(_this.form.yonghuYesnoTypes == "请选择用户审核"){
                    _this.$message.error("请选择用户审核");
                    return false;
                }
                this.$http({
                    url:`yonghu/shenhe`,
