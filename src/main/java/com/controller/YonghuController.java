...
//            return R.error(511,"永远不会进入");
    ...
    */
    ...
    public R shenhe(@RequestBody YonghuEntity yonghuEntity, HttpServletRequest request){
        logger.debug("shenhe方法:,,Controller:{},,yonghuEntity:{}",this.getClass().getName(),yonghuEntity.toString());

//        if(yonghuEntity.getYonghuYesnoTypes() == 2){//通过
//            yonghuEntity.setYonghuTypes();
//        }else if(yonghuEntity.getYonghuYesnoTypes() == 3){//拒绝
//            yonghuEntity.setYonghuTypes();
//        }
        yonghuService.updateById(yonghuEntity);//审核
        return R.ok();
    }
...
//                            yonghuEntity.setYonghuYesnoTypes(Integer.valueOf(data.get(0)));   //用户审核 要改的
//                            yonghuEntity.setCreateTime(date);//时间
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        else if(yonghu.getYonghuYesnoTypes() != 2)
            return R.error("账号审核未通过或已拒绝");
        //  // 获取监听器中的字典表
